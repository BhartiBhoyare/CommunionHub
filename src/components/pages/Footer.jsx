    ...
    <footer className="text-[#ffff] bg-[#526039] p-4 md:p-12">
      <div className="flex flex-col md:flex-row gap-4 justify-between items-start">
        <div className="space-y-6">
          <h2 className="flex text-3xl font-extrabold text-[#e3edbe] mb-3">CommunionHub</h2>
        ...
        <div className="flex flex-col space-y-4 justify-center mb-4">
            <p className="font-extrabold">Contact</p>
          <a href="" className="hover:text-gray-300">communion@gmail.com</a>
        </div>
      </div>
      <div className="h-0.5 w-full bg-[#6a7856]"></div>
      <p className="text-sm mt-6 text-[#e7f5d3]">
        &copy; {new Date().getFullYear()} CommunionHub. All Rights Reserved to CommunionHub.
      </p>
    </footer>
  );
};
